...
* Table of Contents                                                     :TOC:
 ...
 - [[#non-package-key-bindings][Non-package Key Bindings]]
     ...
     - [[#eww-key-binding-tweaks][=eww= key binding tweaks]]
...
#+BEGIN_SRC emacs-lisp
  (bind-keys :prefix-map jtg:term-map
             :prefix-docstring "Keymap used to jump between multiple ansi-term instances."
             :prefix "C-c t"
             ("0" . (lambda () (interactive) (jtg:jump-to-or-start-term 0)))
             ("1" . (lambda () (interactive) (jtg:jump-to-or-start-term 1)))
             ("2" . (lambda () (interactive) (jtg:jump-to-or-start-term 2)))
             ("3" . (lambda () (interactive) (jtg:jump-to-or-start-term 3)))
             ("4" . (lambda () (interactive) (jtg:jump-to-or-start-term 4)))
             ("5" . (lambda () (interactive) (jtg:jump-to-or-start-term 5)))
             ("6" . (lambda () (interactive) (jtg:jump-to-or-start-term 6)))
             ("7" . (lambda () (interactive) (jtg:jump-to-or-start-term 7)))
             ("8" . (lambda () (interactive) (jtg:jump-to-or-start-term 8)))
             ("9" . (lambda () (interactive) (jtg:jump-to-or-start-term 9))))
#+END_SRC

** =eww= key binding tweaks

Eww is cool and all, but a little weird. The key bindings are a bit strange, and
the buffer doesn't start out in read-only mode.
